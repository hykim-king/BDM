...
document.addEventListener("DOMContentLoaded", function(){
	...
	$("#kakaoIdLogin_loginButton").on("click",function(e){
		location.href = "/bdm/beforeMain/moveKakaologin.do";
	});
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;">
                        	...
                        	<input type="button" value="카카오로그인" id="kakaoIdLogin_loginButton" style="height: 30px; width: 100%; href="javascript:void(0)">
                        </td>
                    </tr>
                </table>
            </form>
