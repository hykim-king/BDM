...
<script >
   ...
   function doSave(){
       ...
       console.log("javascript levelIntValue:"+document.querySelector("#levelIntValue").value);
      ...
      // console.log("jquery name:"+$("#name").val());
       ...
       if(eUtil.isEmpty(document.querySelector("#levelIntValue").value) == true){
           alert('성별을 입력하세요.');
           //$("#userId").focus();//사용자 id에 포커스
           document.querySelector("#levelIntValue").focus();
           return;
       }    
       ...
       $.ajax({
           ...
           data:{
	       	   ...
	       	   gender: document.querySelector("#levelIntValue").value,
	     ...
	     <div>
	       <form action="#" name="userRegFrm">
	           ...
	           <div class="mb-3">
	               ...
	               <input type="button" class="btn btn-primar" value="중복확인" id="idDuplicateCheck"      onclick="window.idDuplicateCheck();">
	           </div>
               ...
               <div class="mb-3">
                   ...
                   <input type="text"  class="form-control" name="birth" id="birth" placeholder="생년월일6자리 입력하세요" size="20"  maxlength="320">
               </div>
               <div class="p-div">
                   <label for="levelIntValue" class="p-label">성별</label>
	            ...
	            <div class="mb-3">
                   ...
                   <input type="text"  class="form-control" name="height" id="height" placeholder="cm제외하고 입력해주세요." size="20"  maxlength="320">
               </div>
                <div class="mb-3">
                   <label for="weight" class="form-label">몸무게</label>
                   <input type="text"  class="form-control" name="weight" id="weight" placeholder="kg제외하고 입력해주세요." size="20"  maxlength="320">
               </div>
	       </form>
	     </div>
	     <!--// 회원 등록영역 ------------------------------------------------------>
