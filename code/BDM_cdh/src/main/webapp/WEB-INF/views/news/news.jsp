...
/*  $("#newsTable>tbody").on("click","tr" , function(e){
    ...
    moveToRegBTN.addEventListener("click",function(e){
        ...
        boardForm.action = "/bdm/board/moveToReg.do";
        boardForm.submit();
    ...
    function doRetrieve(pageNo){
        ...
        boardForm.action = "/bdm/board/doRetrieve.do";
          ...
          <div class="col-auto">
              <select class="form-select pcwk_select" id="searchDiv" name="searchDiv">
                     ...
                     <c:forEach var="vo" items="${NewsSearch }">
                        <option value="<c:out value='${vo.category}'/>"  <c:if test="${vo.category == paramVO.searchDiv }">selected</c:if>  ><c:out value="${vo.div_name}"/></option>
                     </c:forEach>
              </select>
          </div>    
          <div class="col-auto">
          ...
          <div class="col-auto"> 
               <select class="form-select" id="pageSize" name="pageSize">
                  <c:forEach var="vo" items="${pageSize }">
                    <option value="<c:out value='${vo.category }' />" <c:if test="${vo.category == paramVO.pageSize }">selected</c:if>  ><c:out value='${vo.div_name}' /></option>
                  </c:forEach>
               </select>  
          </div>    
