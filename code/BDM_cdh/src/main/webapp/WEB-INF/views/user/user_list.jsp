           ...
           <div class="row g-1 justify-content-end "> 
               ...
               <select class="form-select" id="pageSize" name="pageSize">
			    ...
			    <div class="col-auto "> <!-- 열의 너비를 내용에 따라 자동으로 설정 -->
				    ...
				    <input type="button" class="btn btn-primary" value="xlsx"  id=downloadUser  >
			    </div>
            </div>
    </form>
...
<%--  <jsp:include page="/WEB-INF/cmn/footer.jsp"></jsp:include>   --%>
 ...
 $( document ).ready(function() {
	 ...
	 const  downloadUserBTN= document.querySelector("#downloadUser");
	 
	 downloadUserBTN.addEventListener("click",function(e){
		   console.log('downloadUserBTN:click');
		   if(confirm('엑셀파일을 다운로드 하시겠습니까?')==false)return;
	        ...
	        //pageNo
	        frm.action = "/ehr/user/downloadUser.do";
	        //서버 전송
	        frm.submit();
